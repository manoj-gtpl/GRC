...
// type FormData = {
//   // id?: number | string;
//   // Organization fields (only the ones you specified)
//   name: string;
//   domain: string;
//   industry: string;
//   size: string;
...
//   city: string;
//   pincode: string;
//   // organization_logo: string | File | null;
//   logo_url: string;

//   // Admin fields (only the ones you specified)
//   admin_name: string;
//   admin_email: string;
//   admin_phone: string;
...
//   // initialFormData uses exactly the fields you supplied (no extras)
...
//     // new organization defaults (only fields you listed)
//     return {
//       name: '',
//       domain: '',
//       industry: '',
...
//   // sync when organization changes or modal opens/closes
//   useEffect(() => {
//     setFormData(initialFormData);
//     setErrors({});
//     // enable assignAdmin if editing and organization already has an admin
//     setAssignAdmin(Boolean(organization?.admin));
//   }, [initialFormData, isOpen, organization]);

//   // canAssignAdmin: only allow when no global existing admin OR editing an org that already has admin
...
//     // Org validations (only for fields you included)
...
//     // Admin validations only when assignAdmin is true
//     if (assignAdmin) {
...
//         }
//       }
//       // If creating a new admin (organization has no admin), require password
...
//     // Build payload using only the exact fields you supplied
...
//     // if (organization?.id) {
//     //   (payload as any).id = organization.id;
//     // }
...
//               {organization ? 'Update organization details' : 'Add a new organization to the platform'}
//             </p>
//           </div>
//           <button
//             onClick={() => {
...
//                     {canAssignAdmin ? 'Assign one admin to this organization' : 'Only one admin can be assigned per organization'}
//                   </p>
//                 </div>
...
//                         Another organization already has an admin assigned. Each organization can only have one admin.
//                       </p>
//                     </div>
//                   </div>
//                 </div>
...
//                         placeholder={organization?.admin ? 'Leave blank to keep existing password' : 'Set admin password'}
//                       />
//                       <button
//                         type="button"
...
//                   <div>
//                     <label className="block text-sm font-medium text-gray-300 mb-2">Profile Image (URL or filename)</label>
//                     <input
//                       type="text"
...
//                   </div>
//                   {/* <div>
//                     <label className="block text-sm font-medium text-gray-300 mb-2">Admin Profile Image</label>
//                     <input
//                       type="file"
//                       accept="image/*"
...
//                       className="block w-full text-sm text-gray-300 bg-gray-900 border border-gray-700 rounded-lg cursor-pointer focus:outline-none focus:ring-2 focus:ring-purple-500"
//                     />
//                     {organization?.admin?.profile_image && !formData.profile_image && (
//                       <p className="text-xs text-gray-500 mt-1">Current image: {organization.admin.profile_image}</p>
//                     )}
//                   </div> */}
//                 </div>
//               )}
